...
Public Class ACY113
    ...
    Dim myds As DataSet
    Private Sub ACY113_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadGridFunc()
        ...
        sqlstr = "select a.*, b.accname as accname from (select * from acf060 where accyear=" & _
                  SYear & " and left(accno,3)='113' and len(accno)>=5 and len(accno)<=16) a " & _
    ...
    Private Sub BtnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPrint.Click
        ...
        Try
            ...
            Dim TOT3, TOT4, TOT5, TOT6, TOT7, TOT8 As Decimal
            TOT3 = 0 : TOT4 = 0 : TOT5 = 0 : TOT6 = 0 : TOT7 = 0 : TOT8 = 0

            Dim tt1, tt2 As String
            Try
                tt1 = "c:\App\acc\報表樣本\ACY113.xls"
                tt2 = "c:\App\acc\報表\ACY113.xls"
                If Not File.Exists(tt1) Then
                    AppReport_Copy("acc", "ACY113.xls", tt1)
            ...
            Catch ex As Exception
                MsgBox("報表copy from " & tt1 & "  to  " & tt2 & " 錯誤，若 \報表\ACY113.XLS 使用中請先關閉之，否則請洽資訊人員!")
            ...
            With myds.Tables("acm010")
                For intR = 0 To .Rows.Count - 1
                    ...
                    NAR(xlRange)
                    xlRange = xlCells(i, 7)
                    xlRange.Value = FormatNumber(.Rows(intR).Item("trans12"), 2)
                    NAR(xlRange)
                    xlRange = xlCells(i, 8)
                    ...
                    If Len(strAccno) = 5 Then '由四級作合計
                        ...
                        TOT7 += .Rows(intR).Item("trans12")
                        TOT8 += .Rows(intR).Item("deamt12") - .Rows(intR).Item("cramt12")
                    End If
                Next
            End With
