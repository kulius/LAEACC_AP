...
Public Class ACY114
    ...
    Private Sub ACY114_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadGridFunc()
        ...
        '丟入dataset 
        sqlstr = "select a.*, c.kind, c.unit, c.qtyin12-c.qtyout12 as qty, b.accname as accname " & _
                 "from (select * from acf050 where accyear=" & SYear & _
                 " and left(accno,3)='114' and len(accno)>=5 and len(accno)<=16 ) a " & _
    ...
    Private Sub BtnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPrint.Click
        ...
        Try
            ...
            Try
                tt1 = "c:\App\acc\報表樣本\ACY114.xls"
                tt2 = "c:\App\acc\報表\ACY114.xls"
                If Not File.Exists(tt1) Then
                    AppReport_Copy("acc", "ACY114.xls", tt1)
            ...
            Catch ex As Exception
                MsgBox("報表copy from " & tt1 & "  to  " & tt2 & " 錯誤，若 \報表\ACY114.XLS 使用中請先關閉之，否則請洽資訊人員!")
