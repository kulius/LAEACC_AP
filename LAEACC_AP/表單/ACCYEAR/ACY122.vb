...
Public Class ACY122
    ...
    Private Sub ACY122_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadGridFunc()
        ...
        sqlstr = "select a.*, b.accname as accname,c.deamt,c.cramt from (select * from acf050 where accyear=" & _
                  SYear & " and left(accno,3)='122' and len(accno)>=5 and len(accno)<=16) a " & _
    ...
    Private Sub BtnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPrint.Click
        ...
        Try
            ...
            Try
                tt1 = "c:\App\acc\報表樣本\ACY122.xls"
                tt2 = "c:\App\acc\報表\ACY122.xls"
                If Not File.Exists(tt1) Then
                    AppReport_Copy("acc", "ACY122.xls", tt1)
            ...
            Catch ex As Exception
                MsgBox("報表copy from " & tt1 & "  to  " & tt2 & " 錯誤，若 \報表\ACY122.XLS 使用中請先關閉之，否則請洽資訊人員!")
