...
Public Class ACY137
    ...
    Private Sub ACY137_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadGridFunc()
        ...
        sqlstr = "select a.*, b.accname as accname from (select * from acf050 where accyear=" & _
                  SYear & " and left(accno,3)='137' and len(accno)>=5 and len(accno)<=16) a " & _
    ...
    Private Sub BtnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPrint.Click
        ...
        Try
            ...
            Try
                tt1 = "c:\App\acc\報表樣本\ACY137.xls"
                tt2 = "c:\App\acc\報表\ACY137.xls"

                If Not File.Exists(tt1) Then
                    AppReport_Copy("acc", "ACY137.xls", tt1)
            ...
            Catch ex As Exception
                MsgBox("報表copy from " & tt1 & "  to  " & tt2 & " 錯誤，若 \報表\ACY137.XLS 使用中請先關閉之，否則請洽資訊人員!")
            ...
            With myds.Tables("acm010")
                For intR = 0 To .Rows.Count - 1
                    ...
                    strAccname = Mid(strAccno, 10, 3) & nz(.Rows(intR).Item("accname"), "")
                    i += 1
