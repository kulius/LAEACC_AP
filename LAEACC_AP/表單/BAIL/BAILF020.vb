    ...
    Private Sub btnInq_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInq.Click
        ...
        If rdbEngnoInq.Checked Then
            ...
            If txtEngnoStart.Text.Trim <> "" And txtEngnoStop.Text.Trim <> "" Then
                sqlstr = "SELECT BAILF020.ENGNO, ENF010.ENGNAME, BAILF020.KIND, bailf020.chkno, bailf020.bank,BAILF020.RP, BAILF020.IDNO, BAILF020.COP, BAILF020.AMT, BAILF020.NO_1_NO,bailf020.autono,bailf020.balance"
                sqlstr &= " ,RPDATE"
                sqlstr &= " ,DATE_S"
                sqlstr &= " ,DATE_E"
                sqlstr &= " FROM BAILF020"
                sqlstr &= " left JOIN ENF010 ON BAILF020.ENGNO = ENF010.ENGNO"
        ...
        Else
            ...
            sqlstr &= " FROM BAILF020"
            sqlstr &= " left JOIN ENF010 ON BAILF020.ENGNO = ENF010.ENGNO"
            sqlstr &= " where bailf020.rpdate>='" & dateSRpdate.ToString("yyyy/M/d", CultureInfo.InvariantCulture) & "' and bailf020.rpdate<='" & dateERpdate.ToString("yyyy/M/d", CultureInfo.InvariantCulture) & "' and (balance is null or balance='') "
