...
Public Class BAIL101
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrt.Click
        ...
        Try
            ...
            sqlstr = "SELECT bailf010.engno as engno,bailf010.kind as kind,bailf010.rpdate as rpdate ,bailf010.rp as rp,bailf010.amt as amt,enf010.engname as engname,bailf010.cop as cop  FROM bailf010 inner join enf010 on bailf010.engno=enf010.engno where (balance is null or balance='') order by bailf010.engno,bailf010.cop,bailf010.kind"
            ...
            For i = 0 To mydataset.Tables("bailf010").Rows.Count - 1
                ...
                Else
                    ...
                    If engno <> strEngno Or cop <> strcop Or kind <> strKind Then
            ...
            mydataset.Clear()
            '保管品
            sqlstr = "SELECT bailf020.engno as engno,bailf020.kind as kind,bailf020.rpdate as rpdate ,bailf020.chkno as chkno,bailf020.rp as rp,bailf020.amt as amt,bailf020.bank as bank,enf010.engname as engname,bailf020.cop as cop  FROM bailf020 inner join enf010 on bailf020.engno=enf010.engno where (balance is null or balance='') order by bailf020.engno,bailf020.cop,bailf020.kind,bailf020.bank,bailf020.chkno"
            ...
            For i = 0 To mydataset.Tables("bailf020").Rows.Count - 1
                ...
                Else
                    ...
                    If rdbcourse1.Checked Then                '依工程及種類
                        ...
                        End If
                    Else
                        If engno <> strEngno Or cop <> strcop Or kind <> strKind Or bank <> strbank Or chkno <> strchkno Then
                            If INCOME - PAY = 0 And UP_IN - UP_PAY = 0 Then
                                INCOME = 0
                                PAY = 0
                                UP_IN = 0
            ...
            Try
                ...
                tt2 = "c:\App\bail\Report\bailf101.xls" ' mypath + "\bailf100.xls"
                FileCopy(tt1, tt2)
                xlapp = CreateObject("Excel.Application")
            ...
            If rdbSave.Checked = True Then
                MsgBox("檔案儲存路徑：" & "C:\App\bail\Report\bailf101.xls", , "保證金系統")
            Else
                xlbook.PrintOut()
            End If
        Finally
    ...
    Sub Bail020List()         '保管品
        ...
        If rdbcourse2.Checked Then
            If strchkno.IndexOf("保證書") >= 0 Then
                If chkCop.Checked Then
