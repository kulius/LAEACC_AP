...
Public Class ACM050
    ...
    Private Sub ACM050_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub BtnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPrint.Click
        ...
        Dim PageRow As Integer = 17  '每頁印27行
        Dim printer As FPPrinter = FPPrinter.SharedPrinter
        Dim document As New FPDocument("催 收 款 項 明 細 表")
        ...
        For PageCnt As Integer = 1 To 99    '頁次
            ...
            page.Add(textUnit)
            Dim textTitle As New FPText("催收款項明細表", 90, 6)
            ...
            Dim grid As New FPTable(0, 17, 253, 162, PageRow, 9)   'x,y,w,h,row,col
            grid.Font.Size = 10
    ...
    Private Sub btnExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            Try
                tt1 = "c:\App\acc\報表樣本\ACM050.xls"
                tt2 = "c:\App\acc\報表\ACM050.xls"
                If Not File.Exists(tt1) Then
                    AppReport_Copy("acc", "ACM050.xls", tt1)
            ...
            Catch ex As Exception
                MsgBox("報表copy from " & tt1 & "  to  " & tt2 & " 錯誤，若 \報表\ACM050.XLS 使用中請先關閉之，否則請洽資訊人員!")
