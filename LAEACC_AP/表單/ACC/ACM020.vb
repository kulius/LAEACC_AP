...
Public Class ACM020
    ...
    Private Sub ACM020_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub BtnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPrint.Click
        ...
        For PageCnt As Integer = 1 To 99    '頁次
            ...
            page.Add(textUnit)
            Dim textTitle As New FPText("收 入 明 細 表", 90, 6)
            ...
            grid.ColumnStyles(1).Width = 73
            grid.ColumnStyles(2).Width = 30
            grid.ColumnStyles(3).Width = 30
            grid.ColumnStyles(4).Width = 30
    ...
    Private Sub btnExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            Try
                tt1 = "c:\App\acc\報表樣本\ACM020.xls"
                tt2 = "c:\App\acc\報表\ACM020.xls"
                If Not File.Exists(tt1) Then
                    AppReport_Copy("acc", "ACM020.xls", tt1)
            ...
            Catch ex As Exception
                MsgBox("報表copy from " & tt1 & "  to  " & tt2 & " 錯誤，若 \報表\ACM020.XLS 使用中請先關閉之，否則請洽資訊人員!")
